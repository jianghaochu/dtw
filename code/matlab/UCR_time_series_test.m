% Testing code for UCR time series archive
% Datasets can be download from https://www.cs.ucr.edu/~eamonn/time_series_data_2018/UCRArchive_2018.zip
% Unzip password: someone

function UCR_time_series_test %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% (C) Eamonn Keogh %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TRAIN = load('UCRArchive_2018/SyntheticControl/SyntheticControl_TRAIN.tsv'); % Only these two lines need to be changed to test a different data set. %
TEST = load('UCRArchive_2018/SyntheticControl/SyntheticControl_TEST.tsv' ); % Only these two lines need to be changed to test a different data set. %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1 : length(TRAIN_class_labels)
    ...
    % distance = dtw(compare_to_this_object, unknown_object, 100, 'squared');
    % distance = dtw(compare_to_this_object, unknown_object, 5, 'squared');
